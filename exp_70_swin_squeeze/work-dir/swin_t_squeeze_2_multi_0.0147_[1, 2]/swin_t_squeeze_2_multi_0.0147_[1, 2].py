roi_feat_size = 7
class_loss_weight = 0.4850945906238795
bbox_loss_weight = 1.2725428795512217
rpn_iou_threshold = 0.9110006265569048
model = dict(
    type='CascadeRCNN',
    backbone=dict(
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='mmdetection',
                name='swin_t_squeeze_2_multi_0.0147_[1, 2]'))
    ])
...
optimizer = dict(
    type='SGD',
    lr=0.01474288698958374,
    momentum=0.9,
    weight_decay=0.005579792275616379)
optimizer_config = dict(
    grad_clip=dict(max_norm=3.983941434115176, norm_type=2))
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=1000,
...
gpu_ids = [0]
seed = 16
work_dir = './work-dir/swin_t_squeeze_2_multi_0.0147_[1, 2]'
