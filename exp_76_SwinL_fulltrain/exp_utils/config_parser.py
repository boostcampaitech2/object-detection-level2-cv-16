...
def config_parser():
    ...
    cfg.class_loss_weight = (2 - args.bbox_loss_weight) #args.class_loss_weight
    cfg.rpn_iou_threshold = args.rpn_iou_threshold

    # optimizer
    cfg.optimizer.lr = args.lr_default
    cfg.lr_config.step = [args.lr_step_1]
    ...
    # ckpt setting
    cfg.checkpoint_config = dict(max_keep_ckpts=0, interval=args.max_epochs)
